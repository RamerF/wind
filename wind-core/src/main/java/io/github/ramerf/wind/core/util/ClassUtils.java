...
public abstract class ClassUtils {
   ...
   * float, or double) or a primitive wrapper (i.e. Boolean, Byte, Character, Short, Integer, Long,
   * Float, or Double).
   *
   * @param clazz the class to check
  ...
  public static boolean isAssignable(Class<?> lhsType, Class<?> rhsType) {
    Asserts.notNull(lhsType, "Left-hand side type must not be null");
    Asserts.notNull(rhsType, "Right-hand side type must not be null");
  ...
  public static String convertResourcePathToClassName(String resourcePath) {
    Asserts.notNull(resourcePath, "Resource path must not be null");
  ...
  public static String convertClassNameToResourcePath(String className) {
    Asserts.notNull(className, "Class name must not be null");
  ...
  public static Method getMethod(
    ...
    Asserts.notNull(clazz, "Class must not be null");
    Asserts.notNull(methodName, "Method name must not be null");
    if (paramTypes != null) {
      try {
