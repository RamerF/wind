...
public class StatementBuilder {
  ...
  public StatementBuilder append(
      JCExpression varType,
      String varName,
      Class invokedClass,
      String method,
      List<JCExpression> params) {
    JCExpression methodInvocation =
        treeMaker.Apply(
            List.nil(),
            treeMaker.Select(aptBuilder.typeRef(invokedClass), aptBuilder.toName(method)),
            params);
    jcStatements.append(
        treeMaker.VarDef(
            treeMaker.Modifiers(Flags.PARAMETER),
            aptBuilder.toName(varName),
            varType,
            methodInvocation));
    return this;
  }
  ...
  public StatementBuilder append(String varName, String methodName, JCExpression... params) {
    JCExpression methodRef =
        treeMaker.Select(aptBuilder.varRef(varName), aptBuilder.toName(methodName));
  ...
  public StatementBuilder append(Class clazz, String methodName, JCExpression... params) {
    JCExpression methodRef =
        treeMaker.Select(aptBuilder.typeRef(clazz), aptBuilder.toName(methodName));
    jcStatements.append(treeMaker.Exec(treeMaker.Apply(List.nil(), methodRef, List.from(params))));
    return this;
  }

  public StatementBuilder append(
      Class typeClass, String name, Class invokedClass, String method, JCExpression... params) {
  ...
  public StatementBuilder append(
      ...
      String method,
      JCExpression... params) {
    JCExpression methodInvoke =
        treeMaker.Apply(
            List.nil(),
            treeMaker.Select(aptBuilder.typeRef(invokedClassName), aptBuilder.toName(method)),
            List.from(params));
    jcStatements.append(
        treeMaker.VarDef(
            treeMaker.Modifiers(Flags.PARAMETER), aptBuilder.toName(name), varType, methodInvoke));
    return this;
  }

  public StatementBuilder append(
      JCExpression varType, String name, String instanceMethodName, JCExpression... params) {
    JCExpression methodInvoke =
        treeMaker.Apply(List.nil(), aptBuilder.varRef(instanceMethodName), List.from(params));
    jcStatements.append(
        treeMaker.VarDef(
            treeMaker.Modifiers(Flags.PARAMETER), aptBuilder.toName(name), varType, methodInvoke));
    return this;
  ...
  public StatementBuilder append(JCExpression varType, String name, JCExpression init) {
    jcStatements.append(
        treeMaker.VarDef(
            treeMaker.Modifiers(Flags.PARAMETER), aptBuilder.toName(name), varType, init));
    return this;
  }
  ...
  public StatementBuilder append(JCTree.JCStatement... statements) {
    jcStatements.appendList(List.from(statements));
    return this;
  }

  public StatementBuilder append(List<JCTree.JCStatement> statements) {
    jcStatements.appendList(statements);
    return this;
  }
