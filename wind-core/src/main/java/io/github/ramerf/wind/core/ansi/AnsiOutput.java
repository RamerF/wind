...
public abstract class AnsiOutput {
   ...
   *
   * @param consoleAvailable if the console is known to be available or {@code null} to use standard
   *     detection logic.
   */
  ...
  /**
   * Create a new ANSI string from the specified elements. Any {@link AnsiElement}s will be encoded
   * as required.
   *
  ...
  /**
   * Possible values to pass to {@link AnsiOutput#setEnabled}. Determines when to output ANSI escape
   * sequences for coloring application output.
   */
  public enum Enabled {

    /**
     * Try to detect whether ANSI coloring capabilities are available. The default value for {@link
     * AnsiOutput}.
     */
    DETECT,
