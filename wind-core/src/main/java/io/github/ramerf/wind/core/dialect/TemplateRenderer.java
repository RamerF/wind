...
public class TemplateRenderer {
  ...
  public String render(List args) {
    ...
    if (getAnticipatedNumberOfArguments() > 0
        && numberOfArguments != getAnticipatedNumberOfArguments()) {
      log.error("render:[{},{}]", getAnticipatedNumberOfArguments(), numberOfArguments);
    }
