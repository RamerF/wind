...
public interface ILambdaCondition<T, U extends ILambdaCondition<T, U>> extends Condition<T, U> {
  ...
  <V> U like(boolean condition, @Nonnull IConsumer<T, V> field, @Nonnull V value);

  default <V> U notLike(@Nonnull IConsumer<T, V> field, @Nonnull V value) {
    return notLike(true, field, value);
  }

  <V> U notLike(boolean condition, @Nonnull IConsumer<T, V> field, @Nonnull V value);
  ...
  <V> U between(
      boolean condition, @Nonnull IConsumer<T, V> field, @Nonnull V start, @Nonnull V end);
  ...
  <V> U orLike(boolean condition, @Nonnull IConsumer<T, V> field, @Nonnull V value);

  default <V> U orNotLike(@Nonnull IConsumer<T, V> field, @Nonnull V value) {
    return orNotLike(true, field, value);
  }

  <V> U orNotLike(boolean condition, @Nonnull IConsumer<T, V> field, @Nonnull V value);
  ...
  <V> U orIn(boolean condition, @Nonnull IConsumer<T, V> field, @Nonnull Collection<V> values);

  default <V> U orNotIn(@Nonnull IConsumer<T, V> field, @Nonnull Collection<V> values) {
    return orNotIn(true, field, values);
  }

  <V> U orNotIn(boolean condition, @Nonnull IConsumer<T, V> field, @Nonnull Collection<V> values);
