...
public class GroupByClause<T> {
  ...
  public GroupByClause<T> col(@Nonnull final GetterFunction<T, ?> function) {
    return col(function, null);
  }

  public GroupByClause<T> col(
      @Nonnull final GetterFunction<T, ?> function, final String columnAlia) {
