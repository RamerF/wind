...
import io.github.ramerf.mybatisturbo.core.handler.TypeConverter;
import io.github.ramerf.mybatisturbo.core.repository.AbstractBaseRepository;
import io.github.ramerf.mybatisturbo.core.statement.InsertStatement;
import io.github.ramerf.mybatisturbo.core.statement.InsertStatement.InsertColumn.InsertValue;
...
public class Update {
  ...
  private <T extends AbstractEntityPoJo> Update from(final Class<T> clazz, final String tableName) {
    final MybatisTurboConfiguration configuration =
        AppContextInject.getBean(MybatisTurboConfiguration.class);
    ...
    this.conditions = QueryColumnFactory.getInstance(clazz).getConditions();
    return this;
  }
  ...
  public <T extends AbstractEntityPoJo> Update where(
    ...
    consumer.accept((Condition<T>) this.conditions);
    this.conditionString = conditions.getString();
