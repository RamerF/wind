...
import io.github.ramerf.mybatisturbo.core.conditions.Condition;
...
import io.github.ramerf.mybatisturbo.core.util.SnowflakeIdWorker;
...
import static io.github.ramerf.mybatisturbo.core.util.BeanUtils.*;
...
public interface UpdateService<T extends AbstractEntityPoJo, E extends AbstractEntity>
   ...
   * @see DataAccessException
   */
  default long delete(Consumer<Condition<T>> consumer) throws RuntimeException {
